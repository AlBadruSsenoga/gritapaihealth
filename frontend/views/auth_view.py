...
<div style="padding: 2rem;">
    ...
    <h1 style="font-size: 2.75rem; margin: 0 0 0.75rem 0; color: white; line-height: 1.15; font-weight: 800;">
        The Future of<br>
        <span style="background: linear-gradient(90deg, #60A5FA, #34D399); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Gritap AI Health </span>
    </h1>
...
<div style="text-align: center; margin-bottom: 1rem;">
    <h2 style="font-size: 1.75rem; margin: 0; color: white; font-weight: 600;">Portal</h2>
    <p style="font-size: 0.95rem; color: #94A3B8; margin: 0.5rem 0 0 0;">Secure Login for Clinicians</p>
</div>
""", unsafe_allow_html=True)
        ...
        st.markdown('<p style="text-align: center; font-size: 0.8rem; color: #475569; margin-top: 1rem;">Powered by Gritap AI Health</p>', unsafe_allow_html=True)
